...
#define __NRF_Utilities_H
   ...
   extern "C" {
    ...
    /*----------------------NRF SPI Peripheral--------------------------------*/
    SPI_HandleTypeDef *NRFSPIHandle = &hspi1;
    GPIO_TypeDef *NRFCSPort = SPI1_CS_GPIO_Port;
    uint16_t NRFCSPin = SPI1_CS_Pin;
    GPIO_TypeDef *NRFCEPort = SPI1_CE_GPIO_Port;
    uint16_t NRFCEPin = SPI1_CE_Pin;
    /*------------------------------------------------------------------------*/
